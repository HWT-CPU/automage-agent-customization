...
def main() -> None:
    ...
    msg_db_cleared = zh("\\u6570\\u636e\\u5e93\\u5df2\\u6e05\\u7a7a\\u5e76\\u5199\\u5165\\u4e2d\\u6587\\u6d4b\\u8bd5\\u6570\\u636e\\u3002")
    msg_table_count = zh("\\u5df2\\u6e05\\u7a7a\\u6570\\u636e\\u8868\\u6570\\u91cf")
    msg_core_stats = zh("\\u6838\\u5fc3\\u6570\\u636e\\u7edf\\u8ba1:")
    msg_test_accounts = zh("\\u6d4b\\u8bd5\\u8d26\\u53f7:")
    msg_chen = zh("\\u9648\\u603b")
    msg_li = zh("\\u674e\\u7ecf\\u7406")
    msg_zhang = zh("\\u5f20\\u4e09")
    msg_wang = zh("\\u738b\\u5c0f\\u7f8e")

    print(msg_db_cleared)
    print(f"{msg_table_count}: {len(truncated_tables)}")
    print(msg_core_stats)
    for table, count in counts.items():
        print(f"- {table}: {count}")
    print(msg_test_accounts)
    print(f"- {msg_chen} / chenzong")
    print(f"- {msg_li} / lijingli")
    print(f"- {msg_zhang} / zhangsan")
    print(f"- {msg_wang} / wangxiaomei")
